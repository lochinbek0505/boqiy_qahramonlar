      ...
      body: Row(
        ...
        children: [
          ...
          Expanded(
            child: SingleChildScrollView(
              child: Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.center, // Barcha narsa markazda turadi
                  children: [
                    ...
                    Container(
                      width: 700.w, // She'r qutisi juda kengayib ketmasligi uchun qat'iyroq o'lcham
                        ...
                        children: [
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                border: Border(
                                  ...
                                  left: BorderSide(color: AppColors.brown, width: 2),
                                ),
                              ),
                            ),
                          ),
                          ...
                          Positioned(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                border: Border(
                                  right: BorderSide(color: AppColors.brown.withOpacity(0.4), width: 2),
                                  bottom: BorderSide(color: AppColors.brown.withOpacity(0.4), width: 2),
                                ),
                              ),
                            ),
                          ),
                            ...
                            child: Align(
                              ...
                              child: Text(
                                ...
                                style: GoogleFonts.crimsonPro(
                                  fontSize: 22.sp, // Kattaroq, o'qishga qulay
                                  color: Colors.black87,
                                  height: 1.8, // Qatorlar orasidagi masofa katta bo'lishi kerak
                                  fontStyle: FontStyle.italic,
                                ),
                                textAlign: TextAlign.left, // She'r vizual tarzda markazda, lekin o'zi chapga taqalgan
                              ),
                            ),
                          ),
                        ],
                    ...
                    Row(
                      ...
                      children: [
                        Container(width: 100.w, height: 1.h, color: AppColors.brown.withOpacity(0.3)),
                        SizedBox(width: 16.w),
                        Icon(Icons.diamond_outlined, color: AppColors.brown, size: 16.sp),
                        SizedBox(width: 16.w),
                        Container(width: 100.w, height: 1.h, color: AppColors.brown.withOpacity(0.3)),
                      ],
                    ),
          ...
          Container(
            ...
            child: MostReadCard(list: popularPoems), // She'rlar ro'yxatini beramiz
          ),
        ],
      ),
    );
